...
import com.lyq.video.dao.VideoDao;
import com.lyq.video.domain.*;
import com.lyq.video.domain.exception.ConditionException;
import com.lyq.video.service.util.FastDFSUtil;
import com.lyq.video.service.util.ImageUtil;
import com.lyq.video.service.util.IpUtil;
...
public class VideoService {
    ...
    public List<VideoBinaryPicture> convertVideoToImage(Long videoId, String fileMd5) throws Exception{
        com.lyq.video.domain.File file = fileService.getFileByMd5(fileMd5);
